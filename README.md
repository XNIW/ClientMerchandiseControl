...
TASK-040 è l'unico task `ACTIVE / FIX`: la re-review Fix 7 ha trovato quattro P3
riproducibili nel binding AST, nell'inventory iOS e nella provenance evidence; sono
in correzione senza espandere lo scope del release candidate.
