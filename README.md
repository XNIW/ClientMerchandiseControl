...
l'unico task `ACTIVE / FIX`: re-review indipendenti `APPROVED`, ma la PR #18
ha riprodotto una failure CI nella fixture firma e deve tornare verde prima di
merge, senza promozione production né credenziali inventate.
