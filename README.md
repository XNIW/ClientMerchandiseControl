...
TASK-040 è l'unico task `ACTIVE / FIX`: Fix 43 chiude le divergenze di stato
`BLOCKED -> TODO/DONE/VALIDATED_PENDING`, ma la re-review ha trovato una seconda
riga CommonMark indentata 1–3 spazi ignorata dal conteggio globale. Fix 44 resta
limitato al parser e alle fixture governance; codice release, candidate 686/207,
fixture iOS 86/86 e blocker di isolamento esterno restano invariati.
