...
TASK-040 è l'unico task `ACTIVE / REVIEW`: il Fix 15 impone cardinalità
globale unica per CA-06/T-04 e la re-review read-only è il prossimo gate.
TestFlight e production restano invariati.
