...
TASK-040 è l'unico task `ACTIVE / REVIEW`: il Fix 40 ripete il link-count sul
descriptor quarantinato, usa il flock del parent directory invece di un lock
pathname sostituibile e verifica ogni entry retained per device/inode/mode e
payload zero. Candidate `686/207`, fixture iOS 84/84, governance 88/88 e gate
completo sono verdi; re-review distinta, PR e CI exact-SHA sono obbligatori.
