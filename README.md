...
TASK-040 è l'unico task `ACTIVE / REVIEW`: il Fix 14 ha chiuso raw
CommonMark/README, coerenza del riepilogo, matrici CA/T e inventario Git
post-SHA; la re-review read-only è il prossimo gate. TestFlight e production
restano invariati.
