...
l'unico task `ACTIVE / REVIEW`: `F-039-CI01` è candidate `CLOSED` dopo la CI
exact-SHA `32016169548` completamente verde e attende la re-review indipendente
finale, senza promozione production né credenziali inventate.
