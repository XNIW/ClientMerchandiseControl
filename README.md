...
TASK-040 è l'unico task `ACTIVE / FIX`: la re-review prodotto Fix 14 è
`APPROVED`, mentre la security re-review richiede il Fix 15 per la cardinalità
globale CA-06/T-04. TestFlight e production restano invariati.
