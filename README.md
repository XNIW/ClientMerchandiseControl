...
TASK-040 è l'unico task `BLOCKED / REVIEW`: Fix 43 lega ora globalmente e nella
tabella canonica l'unica riga TASK-040 allo stato header, con regressione esatta
`BLOCKED -> TODO` respinta. Codice release, candidate 686/207 e fixture iOS
86/86 restano invariati. Il task attende una re-review distinta e rimane bloccato
finché manca supervisor/namespace enforceable o decisione esplicita sul threat
model.
