...
TASK-040 è l'unico task `ACTIVE / REVIEW`: i finding su binding app/archive,
firma/entitlement, profilo embedded, runtime attestation, scanner e gate CI sono stati
corretti e consegnati a re-review indipendente. Distribution, provisioning, App Store
Connect key e upload TestFlight restano esterni e non sono stati inventati.
