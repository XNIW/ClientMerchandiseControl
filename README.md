...
TASK-040 è l'unico task `ACTIVE / REVIEW`: Fix 11 rende univoci manifest e
matrici, richiede stati `PASS` strutturati e valida l'intera cronologia task senza
comment-decoy. TestFlight e production restano invariati.
