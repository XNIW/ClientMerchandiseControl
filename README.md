...
TASK-040 è l'unico task `ACTIVE / FIX`: la re-review Fix 38 ha chiuso
l'ancestor ABA ma ha riprodotto tre P3 nel lifecycle/cleanup temporaneo:
terminali name-based dopo la verifica, identità acquisita dopo `mktemp` e
crescita nominale dei tombstone. Candidate `686/207`, fixture iOS 76/76 e
governance 88/88 restano verdi; Fix 39, re-review distinta, PR e CI exact-SHA
sono obbligatori. Activation invariata.
