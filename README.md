...
TASK-040 è l'unico task `ACTIVE / FIX`: la re-review Fix 4 lascia cinque P3 su
override workflow-level, lexer Dart, allowlist Apple, race FIFO ed evidence digest.
