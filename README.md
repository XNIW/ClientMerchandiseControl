...
TASK-040 è l'unico task `ACTIVE / FIX`: la review indipendente ha richiesto fix
fail-closed su binding app/archive, firma/entitlement, profilo embedded, runtime
attestation, scanner e gate CI. Distribution, provisioning, App Store Connect key e
