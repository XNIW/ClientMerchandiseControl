...
TASK-040 è l'unico task `ACTIVE / REVIEW`: il Fix 7 lega i consumer AST al field
risolto e rende exact l'inventory framework/bundle; i due PoC Fix 6 sono regressioni
dedicate e il candidate clean è consegnato a re-review distinta.
