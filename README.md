...
TASK-040 è l'unico task `ACTIVE / FIX`: la re-review Fix 35 ha riprodotto due P2
su ABA snapshot/extract e tre P3 su count ZIP reale, rollback e path runbook.
Candidate `686/207`, fixture iOS 65/65 e governance 88/88 restano verdi, ma Fix 36,
re-review distinta, PR e CI exact-SHA sono obbligatori. Activation invariata.
