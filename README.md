...
TASK-040 è l'unico task `ACTIVE / FIX`: la re-review Fix 37 ha riprodotto un
P2 sull'ABA di un ancestor sopra il parent sorvegliato e due P3 sul cleanup
path-based del temp root e sul child `stat→open`. Candidate `686/207`, fixture
iOS 73/73 e governance 88/88 restano verdi, ma Fix 38, re-review distinta, PR
e CI exact-SHA sono obbligatori. Activation invariata.
