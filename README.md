...
TASK-040 è l'unico task `ACTIVE / REVIEW`: il Fix 17 vieta fail-closed entity,
escape, markup e caratteri non ASCII sulle righe tabellari e attende re-review
read-only. TestFlight e production restano invariati.
