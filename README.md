...
TASK-040 è l'unico task `ACTIVE / FIX`: Fix 10 ha chiuso l'attestazione Mach-O;
la re-review richiede Fix 11 per rendere univoci manifest e matrici e validare la
cronologia task senza comment-decoy. TestFlight e production restano invariati.
