...
TASK-040 è l'unico task `ACTIVE / FIX`: la re-review ha chiuso parte dei finding ma
ha riprodotto gap residui su firma, binding archive/runtime, scanner/CMS e gate
CI/privacy. Distribution, provisioning, App Store Connect key e upload TestFlight
