...
TASK-040 è l'unico task `ACTIVE / REVIEW`: Fix 12 vincola la semantica Markdown,
il ciclo corrente, il tail worklog e le revisioni alla lineage Git reale con
44/44 fixture. TestFlight e production restano invariati.
