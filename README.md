...
TASK-040 è l'unico task `ACTIVE / REVIEW`: Fix 37 lega il parent al guard,
osserva gli attribute ABA e rende il cleanup quarantine inode-bound. Candidate
`686/207`, fixture iOS 73/73, governance 88/88 e gate completo exact-SHA sono
