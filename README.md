...
TASK-040 è l'unico task `ACTIVE / FIX`: la re-review Fix 11 ha richiesto il
Fix 12 per vincolare la semantica Markdown, il ciclo corrente, il tail worklog e
le revisioni alla lineage Git reale. TestFlight e production restano invariati.
