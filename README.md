...
ora in `EXECUTION` sul worktree dedicato: TASK-005–TASK-008 e TASK-010 sono
`VALIDATED_PENDING_INTEGRATED_REVIEW`, TASK-009 è l'unico task attivo e gli altri task
