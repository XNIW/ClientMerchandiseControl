...
TASK-040 è l'unico task `ACTIVE / REVIEW`: il Fix 38 lega l'intera ancestor
chain al guard e sostituisce il cleanup path-based con un cleanup
identity-bound, includendo il confronto `fstat` dei child aperti. Candidate
`686/207`, fixture iOS 76/76, governance 88/88 e gate completo exact-SHA sono
verdi; re-review distinta, PR e CI exact-SHA restano obbligatori. Activation
invariata.
