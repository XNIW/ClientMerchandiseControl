...
TASK-040 è l'unico task `ACTIVE / FIX`: la re-review Fix 16 richiede il
Fix 17 per vietare fail-closed entity, escape e markup capaci di camuffare gli
ID tabellari. TestFlight e production restano invariati.
