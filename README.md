...
TASK-040 è l'unico task `ACTIVE / REVIEW`: Fix 2 ha chiuso i gap riprodotti su firma,
binding archive/runtime, attestazione semantica, scanner/CMS e gate CI/privacy e li
consegna a re-review indipendente. Distribution, provisioning, App Store Connect key
e upload TestFlight restano esterni e non sono stati inventati.
