...
| Catalogo inventory operativo | Dominio Merchandise Control, rappresentato online da Admin/Supabase | Shop owner/manager autorizzato | Admin server, Android/iOS autorizzati; import POS solo via Admin | Futuro pipeline TASK-006 | Admin, Android, iOS e POS | Admin per il contratto condiviso | Admin con coordinamento mobile/POS |
