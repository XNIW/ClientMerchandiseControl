...
- **Prossima azione autorizzata**: fix limitato ai finding security
  `F-039-SR01`–`F-039-SR05`, poi re-review indipendente exact-SHA; nessun upload
  senza signing e credenziali Play reali
