...
- **Prossima azione autorizzata**: correggere i finding residui TASK-040 su firma,
  binding archive/runtime, scanner/CMS e gate CI/privacy, quindi nuova re-review;
