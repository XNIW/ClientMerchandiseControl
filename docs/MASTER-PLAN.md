...
- **Prossima azione autorizzata**: Fix 45 sulla matrice ruolo/indicatore del
  verdict `CODEX_REVIEW_BLOCKED`, poi re-review distinta; il boundary esterno
  resta necessario. Upload TestFlight `NOT_RUN`
