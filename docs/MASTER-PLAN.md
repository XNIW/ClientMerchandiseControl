...
- **Prossima azione autorizzata**: re-review distinta del blocker Fix 42;
  sblocco solo con supervisor/namespace enforceable, VM effimera con teardown
  trusted o decisione USER_APPROVER sul threat model. Upload TestFlight `NOT_RUN`
