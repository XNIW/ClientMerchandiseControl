...
- **Prossima azione autorizzata**: re-review distinta Fix 43 del binding
  header/riga backlog; poi resta necessario un boundary di isolamento esterno
  o una decisione esplicita sul threat model. Upload TestFlight `NOT_RUN`
