...
- **Prossima azione autorizzata**: Fix 44 sul conteggio globale delle righe
  CommonMark indentate 1–3 spazi, poi re-review distinta; il blocker di
  isolamento esterno resta invariato. Upload TestFlight `NOT_RUN`
