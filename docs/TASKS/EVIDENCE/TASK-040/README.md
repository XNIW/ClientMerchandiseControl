...
| T-03 | PASS | plist/privacy per-SDK/entitlement/framework/dSYM + fixture iOS 17/17 |
...
| T-07 | NOT_RUN | Fix 6 handoff pronto; re-review, PR/main CI e hygiene da eseguire |
