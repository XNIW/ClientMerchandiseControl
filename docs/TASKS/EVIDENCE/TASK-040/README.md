...
| T-07 | NOT_RUN | Fix 14 handoff pronto; re-review, PR/main CI e hygiene da eseguire |
...
## Gate executor corrente — Fix 14

- `scripts/check.sh`: exit 0;
- non-performance 801/801; performance 10/10; resilience repeat 70/70;
- format 301 file/0 cambi; analyze 0 issue;
- governance 70/70; architecture negative 17/17; localization/telemetry/action pin PASS;
- security source 682; artifact 207; fixture negative 61/61, positive 7/7;
- validator iOS avversariale 29/29 già invariato; governance mirata 70/70;
