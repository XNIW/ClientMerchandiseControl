...
| TASK-040 | ACTIVE / REVIEW | `d94b071` technical | `59668348`, read-only | NOT_RUN | Fix 7 consegnato a re-review; app/archive unsigned validi; Distribution/profile/ASC key esterni |
