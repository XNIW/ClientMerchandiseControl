...
| TASK-040 | ACTIVE / REVIEW | `41f5cba` technical | `59668348`, read-only | NOT_RUN | Fix 8 consegnato a re-review; archive unsigned valido; Distribution/profile/ASC esterni |
