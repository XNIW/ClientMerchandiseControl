...
| TASK-040 | ACTIVE / REVIEW | `2523385` technical | `59668348`, read-only | NOT_RUN | Fix 6 consegnato a re-review; app/archive unsigned validi; Distribution/profile/ASC key esterni |
