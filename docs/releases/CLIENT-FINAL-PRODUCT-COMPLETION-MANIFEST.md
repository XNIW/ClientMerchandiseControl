...
| TASK-040 | ACTIVE / REVIEW | `4c4db2a` technical | `59668348`, read-only | NOT_RUN | app/archive unsigned validi; Distribution/profile/ASC key esterni; review da eseguire |
