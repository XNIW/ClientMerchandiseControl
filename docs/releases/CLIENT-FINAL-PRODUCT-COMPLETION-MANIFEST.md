...
| TASK-040 | ACTIVE / FIX | `ae452c6` technical | `59668348`, read-only | NOT_RUN | tre P3 Fix 5 da correggere; app/archive unsigned validi; Distribution/profile/ASC key esterni |
