...
|---|---|---|---|---|---|---|---|---|---|---|
| ClientMerchandiseControl | `integration/storefront-v1` | pre-transition `b7e2e8e` | `#5 DRAFT` | n/a | `CMC-STOREFRONT-LOGICAL 1.0.0` | Auth/schema/projection staging `PASS` | production Storefront/orders/push/payment `OFF` | TASK-006 checkpoint `PASS` | TASK-010 | revert commit/branch; feature flag OFF |
| merchandise-control-admin-web | `integration/storefront-v1` | `a2a45ef84b19e39d21e42673c31e2e8fc90e88f4` | `#67 DRAFT` | `20260801213500` | projection v1; public API `NOT_RUN` | apply `30719348489`, smoke behavior/rollback `PASS` | production `OFF` | CI `30719303538`, Cloudflare `30719303536`, staging apply `30719348489` `PASS` | TASK-010 API | migration additive + feature flag OFF |
