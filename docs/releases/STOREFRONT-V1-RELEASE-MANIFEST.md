...
|---|---|---|---|---|---|---|---|---|---|---|
| ClientMerchandiseControl | `integration/storefront-v1` | TASK-016 candidate `242e631805b569a49a0217c4129b1586e8ad1dbf` | `#5 DRAFT` | n/a | `storefront.v1` | Detail Android/iOS `PASS`; CI `30735374419` 3/3 `PASS` | production Storefront/orders/push/payment `OFF` | TASK-016 checkpoint `PASS` | TASK-017 offline cache | revert commit/branch; feature flag OFF |
