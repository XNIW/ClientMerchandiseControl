...
|---|---|---|---|---|---|---|---|---|---|---|
| ClientMerchandiseControl | `integration/storefront-v1` | TASK-013 candidate `2aefa17f901652bf2f1fceafb2649422c6b8fb4f` | `#5 DRAFT` | n/a | `storefront.v1` | fixture + Home Android/iOS `PASS`; CI `30732213362` 3/3 `PASS` | production Storefront/orders/push/payment `OFF` | TASK-013 checkpoint `PASS` | TASK-014 catalog grid | revert commit/branch; feature flag OFF |
| merchandise-control-admin-web | `integration/storefront-v1` | `a9036f0bda741d686afbdac13d3d08ef897f059b` | `#67 DRAFT` | `20260802033000` | `storefront.v1` | deploy `30731372117`; fixture/acceptance `30731760038`, CI `30731757331`, tutti `PASS` | production `OFF` | fixture client persistente `PASS` | TASK-014 live catalog | migration additive + feature flag OFF |
