...
|---|---|---|---|---|---|---|---|---|---|---|
| ClientMerchandiseControl | `integration/storefront-v1` | governance `7b7931b03831090241a40602dc999b846a75a9f0`; checkpoint `55c774ee1b6c10b237eaf327ecb16a02648accb7` | `#5 DRAFT` | n/a | `CMC-STOREFRONT-LOGICAL 1.0.0` | Auth staging `PASS`; Storefront `NOT_RUN` | production Storefront/orders/push/payment `OFF` | Governance `PASS` | TASK-005 | revert commit/branch; nessuna write backend |
