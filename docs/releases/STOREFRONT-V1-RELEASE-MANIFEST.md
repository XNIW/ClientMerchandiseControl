...
|---|---|---|---|---|---|---|---|---|---|---|
| ClientMerchandiseControl | `integration/storefront-v1` | TASK-014 candidate `61d8781c58b0c4acb41a80c1eab1f32412c037a8` | `#5 DRAFT` | n/a | `storefront.v1` | Catalog Android/iOS `PASS`; CI `30733287396` 3/3 `PASS` | production Storefront/orders/push/payment `OFF` | TASK-014 checkpoint `PASS` | TASK-015 search/filter/sort | revert commit/branch; feature flag OFF |
| merchandise-control-admin-web | `integration/storefront-v1` | `a9036f0bda741d686afbdac13d3d08ef897f059b` | `#67 DRAFT` | `20260802033000` | `storefront.v1` | deploy `30731372117`; fixture/acceptance `30731760038`, CI `30731757331`, tutti `PASS` | production `OFF` | Catalog live Client `PASS` | TASK-015 live discovery | migration additive + feature flag OFF |
