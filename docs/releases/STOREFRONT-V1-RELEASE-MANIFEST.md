...
|---|---|---|---|---|---|---|---|---|---|---|
| ClientMerchandiseControl | `integration/storefront-v1` | TASK-015 candidate `6739bf663cca2dcad4dcd2ef11ee2415b238daeb` | `#5 DRAFT` | n/a | `storefront.v1` | Discovery Android/iOS `PASS`; CI `30734363845` 3/3 `PASS` | production Storefront/orders/push/payment `OFF` | TASK-015 checkpoint `PASS` | TASK-016 product detail | revert commit/branch; feature flag OFF |
| merchandise-control-admin-web | `integration/storefront-v1` | `a9036f0bda741d686afbdac13d3d08ef897f059b` | `#67 DRAFT` | `20260802033000` | `storefront.v1` | deploy `30731372117`; fixture/acceptance `30731760038`, CI `30731757331`, tutti `PASS` | production `OFF` | Discovery live Client `PASS` | TASK-016 live detail | migration additive + feature flag OFF |
