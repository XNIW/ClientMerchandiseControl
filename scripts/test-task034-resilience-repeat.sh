...
cmc_name_pattern='doppio tap condivide un solo launch|cambio categoria cancella e ignora|doppio tap account produce una sola mutation|doppio tap con richiesta attiva|doppio tap serializzato crea una sola cancellazione|terminal snapshot cannot be overwritten'
...
printf 'TASK-034 resilience repeat: %s iterazioni, 6 race per iterazione, PASS.\n' \
  "${cmc_repeat_count}"
